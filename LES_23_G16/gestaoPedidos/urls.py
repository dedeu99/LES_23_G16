...
from .views import consultar_pedidos,criar_pedido_horario,alterar_pedido_horario,apagar_pedido_horario, criar_pedido_uc, alterar_pedido_uc, apagar_pedido_uc
